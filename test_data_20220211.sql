...
values(1001,'김명선','captain','전임강사',550,to_date('1990-06-23','YYYY-MM-DD'),100,101,'captain@abc.net','http://www.abc.net');

insert into professor
values(1002,'김명신','sweety','정교수',380,to_date('1997-01-30','YYYY-MM-DD'),60,101,'sweety@abc.net','http://www.abc.net');

insert into professor
values (1003,'김자바','powerman','전임강사',270,to_date('2008-03-22','YYYY-MM-DD'),null,101,'pman@power.com','http://www.power.com');

insert into professor
values (2011,'엄호선','lamb1','전임강사',250,to_date('2011-09-01','YYYY-MM-DD'),null,102,'lamb1@hamail.net',null);

insert into professor
values (2012,'장혜진','number1','조교수',350,to_date('1995-11-30','YYYY-MM-DD'),80,102,'number1@naver.com','http://num1.naver.com');

insert into professor
values (2013,'이창익','bluedragon','정교수',490,to_date('1992-04-29','YYYY-MM-DD'),90,102,'bdragon@naver.com',null);

insert into professor
values (3001,'김도형','angel1004','정교수',530,to_date('1991-10-23','YYYY-MM-DD'),110,103,'angel1004@hanmir.com',null);

insert into professor
values (3002,'나한열','naone10','조교수',330,to_date('2007-07-01','YYYY-MM-DD'),50,103,'naone10@empal.com',null);

insert into professor
values (3003,'김현정','only-u','전임강사',290,to_date('2012-02-24','YYYY-MM-DD'),null,103,'only_u@abc.com',null);

insert into professor
values (4001,'심슨','simson','정교수',570,to_date('1991-10-23','YYYY-MM-DD'),130,201,'chebin@daum.net',null);

insert into professor
values (4002,'최슬기','gogogo','조교수',330,to_date('2019-08-30','YYYY-MM-DD'),null,201,'gogogo@def.com',null);

insert into professor
values (4003,'나몰라','mypride','조교수',310,to_date('2009-12-01','YYYY-MM-DD'),50,202,'mypride@hanmail.net',null);

insert into professor
values (4004,'아이유','ironman','전임강사',260,to_date('2019-01-28','YYYY-MM-DD'),null,202,'ironman@naver.com',null);

insert into professor
values (4005,'바비','standkang','정교수',500,to_date('1995-09-18','YYYY-MM-DD'),80,203,'standkang@naver.com',null);

insert into professor 
values (4006,'비','napeople','전임강사',220,to_date('2010-06-28','YYYY-MM-DD'),null,301,'napeople@jass.com',null);

insert into professor
values (4007,'김태희','silver-her','조교수',290,to_date('2011-05-23','YYYY-MM-DD'),30,301,'silver-her@daum.net',null);
...
9411,'홍길동','75true',4,'7510231901813',to_date('1975-10-23','YYYY-MM-DD'),'055)381-2158',180,72,101,201,1001);

insert into student values (
9412,'이사랑','pooh94',4,'7502241128467',to_date('1975-02-24','YYYY-MM-DD'),'051)426-1700',172,64,102,null,2011);

insert into student values (
9413,'조아해','angel000',4,'7506152123648',to_date('1975-06-15','YYYY-MM-DD'),'053)266-8947',168,52,103,203,3002);

insert into student values (
9414,'나학생','gunmandu',4,'7512251063421',to_date('1975-12-25','YYYY-MM-DD'),'02)6255-9875',177,83,201,null,4001);

insert into student values (
9415,'누구야','pincle1',4,'7503031639826',to_date('1975-03-03','YYYY-MM-DD'),'031)740-6388',182,70,202,null,4003);

insert into student values (
9511,'이서진','bingo',3,'7601232186327',to_date('1976-01-23','YYYY-MM-DD'),'055)333-6328',164,48,101,null,1002);

insert into student values (
9512,'유해진','jjang1',3,'7604122298371',to_date('1976-04-12','YYYY-MM-DD'),'051)418-9627',161,42,102,201,2012);
...
insert into student values (
9515,'몰라두','shyun1',3,'7610122196482',to_date('1976-10-12','YYYY-MM-DD'),'02)312-9838',171,54,201,null,4001);

insert into student values (
9611,'일지매','onejimae',2,'7711291186223',to_date('1977-11-29','YYYY-MM-DD'),'02)6788-4861',182,72,101,null,1002);

insert into student values (
9612,'김진욱','samjang7',2,'7704021358674',to_date('1977-04-02','YYYY-MM-DD'),'055)488-2998',171,70,102,null,2011);
...
insert into student values (
9714,'김주현','kimjh',1,'7803241991997',to_date('1978-03-24','YYYY-MM-DD'),'055)423-9870',179,81,102,null,null);
...
INSERT INTO EMP2 VALUES (20000101,'나사장',TO_DATE('19640125','YYYYMMDD'),'0001','정규직','054)223-0001','음악감상',100000000,'대표이사',null);
INSERT INTO EMP2 VALUES (20060101,'전부장',TO_DATE('19730322','YYYYMMDD'),'1000','정규직','02)6255-8000','독서',72010000,'부장',20000101);
INSERT INTO EMP2 VALUES (20070201,'최일도',TO_DATE('19750415','YYYYMMDD'),'1000','정규직','02)6255-8005','운동',50000000,'과장',20060101);
INSERT INTO EMP2 VALUES (20030331,'백원만',TO_DATE('19760525','YYYYMMDD'),'1001','정규직','02)6255-8010','자전거타기',60000000,'차장',20060101);
INSERT INTO EMP2 VALUES (20050303,'천만득',TO_DATE('19730615','YYYYMMDD'),'1002','정규직','02)6255-8020','마라톤',56000000,'과장',20060101);
INSERT INTO EMP2 VALUES (20066102,'일지매',TO_DATE('19720705','YYYYMMDD'),'1003','정규직','052)223-4000','음악감상',75000000,'부장',20000101);
INSERT INTO EMP2 VALUES (20030402,'유관순',TO_DATE('19720815','YYYYMMDD'),'1004','정규직','042)998-7005','등산',51000000,'과장',20066102);
INSERT INTO EMP2 VALUES (20060303,'김문호',TO_DATE('19710925','YYYYMMDD'),'1005','정규직','031)564-3340','등산',35000000,'대리',20066102);
INSERT INTO EMP2 VALUES (20070112,'노정호',TO_DATE('19761105','YYYYMMDD'),'1006','정규직','054)223-4500','수영',68000000,'부장',20000101);
INSERT INTO EMP2 VALUES (20060212,'이윤나',TO_DATE('19721215','YYYYMMDD'),'1007','정규직','054)223-4600',null,49000000,'과장',20070112);
INSERT INTO EMP2 VALUES (20100101,'이태백',TO_DATE('19950125','YYYYMMDD'),'1008','계약직','051)123-4567','등산', 30000000,'',20060212);
INSERT INTO EMP2 VALUES (20100102,'김설악',TO_DATE('19930322','YYYYMMDD'),'1009','계약직','031)234-5678','낚시', 30000000,'',20060212);
INSERT INTO EMP2 VALUES (20100203,'최오대',TO_DATE('19920415','YYYYMMDD'),'1010','계약직','02)2345-6789','바둑', 30000000,'',20060212);
INSERT INTO EMP2 VALUES (20100334,'박지리',TO_DATE('19910525','YYYYMMDD'),'1011','계약직','053)456-7890','노래', 30000000,'',20060212);
INSERT INTO EMP2 VALUES (20100305,'정북악',TO_DATE('19900615','YYYYMMDD'),'1008','수습직','051)567-8901','독서', 22010000,'',20060212);
INSERT INTO EMP2 VALUES (20106106,'유도봉',TO_DATE('19900705','YYYYMMDD'),'1009','수습직','031)678-9012','술',   22010000,'',20060212);
INSERT INTO EMP2 VALUES (20100407,'윤주왕',TO_DATE('19900815','YYYYMMDD'),'1010','수습직','02)2789-0123','오락', 22010000,'',20060212);
INSERT INTO EMP2 VALUES (20100308,'강월악',TO_DATE('19900925','YYYYMMDD'),'1011','인턴직','053)890-1234','골프', 20100000,'',20060212);
INSERT INTO EMP2 VALUES (20100119,'장금강',TO_DATE('19901105','YYYYMMDD'),'1004','인턴직','042)901-2345','술',   20100000,'',20030402);
INSERT INTO EMP2 VALUES (20100210,'나한라',TO_DATE('19901215','YYYYMMDD'),'1005','인턴직','031)345-3456','독서', 20100000,'',20060303);
COMMIT;
...
insert into gift values(2,'샴푸세트',100001,201000);
insert into gift values(3,'세차용품세트',201001,300000);
...
insert into gogak values (20110001,'서진수','7510231369824',980000);
insert into gogak values (20110002,'서재수','7502241128467',73000);
insert into gogak values (20110003,'이미경','7506152123648',320100);
insert into gogak values (20110004,'김재수','7512251063421',65000);
insert into gogak values (20110005,'박동호','7503031639826',180000);
insert into gogak values (20110006,'김신영','7601232186327',153000);
insert into gogak values (20110007,'신은경','7604212298371',273000);
insert into gogak values (20110008,'오나라','7609112118379',315000);
insert into gogak values (20110009,'김설희','7601202378641',542010);
insert into gogak values (20110010,'임세현','7610122196482',265000);
insert into gogak values (20110011,'최순규','7711291186223',110000);
insert into gogak values (20110012,'정현영','7704021358674',99000);
insert into gogak values (20110013,'안광훈','7709131276431',470000);
insert into gogak values (20110014,'모병환','7702261196365',298000);
insert into gogak values (20110015,'노정호','7712141254963',420100);
insert into gogak values (20110016,'이윤나','7808192157498',598000);
insert into gogak values (20110017,'안은수','7801051776346',625000);
insert into gogak values (20110018,'인영민','7808091786954',670000);
insert into gogak values (20110019,'김지영','7803242114563',770000);
insert into gogak values (20110020,'허우','7802232116784',730000);
commit ;
...
insert into p_grade values ('주임',0,24,1,2,12010000,29990000);
